...
data_ip="https://raw.githubusercontent.com/xyoruz/izin/main/ip"
checking_sc() {
...
echo -e " ›TEAM : XYR-VPN STORE ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/xyoruz/izin/main/ip"
# USERNAME
rm -f /usr/bin/user
